...
function () {
  ...
  AppModule = __decorate([core_1.NgModule({
    declarations: [app_component_1.AppComponent, home_component_1.HomeComponent, not_found_component_1.NotFoundComponent, login_component_1.LoginComponent, dashboard_component_1.DashboardComponent, homepage_component_1.HomepageComponent, superhome_component_1.SuperhomeComponent, about_component_1.AboutComponent, googlemaps_component_1.GooglemapsComponent, super_slot_component_1.SuperSlotComponent, contact_component_1.ContactComponent, signup_component_1.SignupComponent, superlist_component_1.SuperlistComponent, hospitalhome_component_1.HospitalhomeComponent, hsopitallist_component_1.HsopitallistComponent, bankhomepage_component_1.bankhomepageComponent, schedule_component_1.ScheduleComponent, geojson_component_1.GeojsonComponent, superslot_component_1.SuperslotComponent, bankslot_component_1.BankslotComponent, hospital_component_1.HospitalComponent, tasks_component_1.TasksComponent, taskbar_component_1.TaskbarComponent, googlemaps2_component_1.Googlemaps2Component, googlemaps3_component_1.Googlemaps3Component, receipt_component_1.ReceiptComponent],
    imports: [platform_browser_1.BrowserModule, app_routing_module_1.AppRoutingModule, button_1.MatButtonModule, google_maps_1.GoogleMapsModule, list_1.MatListModule, form_field_1.MatFormFieldModule, forms_1.ReactiveFormsModule, http_1.HttpClientModule, grid_list_1.MatGridListModule, select_1.MatSelectModule, animations_1.BrowserAnimationsModule, overlay_1.OverlayModule],
    providers: [],
